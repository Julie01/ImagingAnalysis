...
for F=1:length(ImagingData)
    ...
    cherry=medfilt1(ImagingData{F}.cherry1(1:7280),5);
    cherry=[ cherry; NaN(7280,1)];
    gcamp=medfilt1(ImagingData{F}.gcamp1(1:7280),5);
    gcamp=[ gcamp; NaN(7280,1)];
...
title([dirname(cd) ': median R/R0 reversals prestimulus '])
...
title([dirname(cd) ': mean R/R0 reversals prestimulus'])
xlabel('s')
